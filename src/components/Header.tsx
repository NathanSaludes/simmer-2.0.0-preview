...
const Header: React.FC<React.HTMLAttributes<HTMLElement> & ThemeProp> = ({
   theme = "light",
   className
}) => {
   return (
      <header
         className={cn(
            "border-b-2 font-adelle-mono text-[1.1rem] leading-tight",
            {
               "border-simmer-white bg-black text-simmer-white":
                  theme === "dark",
      ...
      >
         <div className="flex min-h-[100px]">
            <Link
               href="/"
               className={cn(
                  "inline-flex w-[217px] items-center justify-center",
                  {
