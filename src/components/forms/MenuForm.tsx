                     ...
                     <div className="h-full px-[50px] py-[48px]">
                        <div className="flex h-full flex-col justify-between">
                           ...
                           <div className="space-y-8">
                              <p>PHASE I</p>
                              <p>
                                 From start-ups, local, international, personal
                                 brands, communities, corporations, businesses
                                 and government agencies— our services has no
                                 creative limits.
                              </p>
                           </div>
                        </div>
                        ...
                        >
                           ...
                           <div className="flex items-center px-[70px] py-[20px]">
                              <div className="basis-full space-y-6">
                                 <p>SERVICE NAME</p>
                                 <p>
                                    From start-ups, local, international,
                                    personal brands, communities, corporations,
